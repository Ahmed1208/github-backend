...
# ------> to create database
#pickle_file_path = 'C:/Users/ahmed/Desktop/ahmed folders/progamming/final project/github backend/features_caltech101.p'
#input_docs(index = 'image3', pickle_path = pickle_file_path)

# ------> to retrive all images' paths and feacture vectors saved in database
#images , pca_features =  get_docs( 'image2' , field = 'features')
#print(len(images))
#print(len(pca_features))

# ------> to retrive all images' paths and feature vectors saved in database for a known "Tag"; ex: "ant"
#images , pca_features = search_by_tags('image2' , "ant")
#print(len(images))
#print(len(pca_features))